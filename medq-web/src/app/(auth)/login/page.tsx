    ...
    <AuthLayout>
      <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="animate-in-up stagger-6">
            <Button
              type="submit"
              className="w-full h-11 rounded-xl text-sm font-medium"
              disabled={loading}
            >
              {loading ? <LoadingButtonLabel label="Signing in..." /> : "Sign In"}
            </Button>
          </div>
        </form>

        {/* Footer */}
        <p className="text-center text-sm text-muted-foreground animate-in-up stagger-7">
