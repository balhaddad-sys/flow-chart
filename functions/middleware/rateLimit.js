...
const RATE_LIMITS = {
  ...
  getAssessmentCatalog:{ maxCalls: 20, windowMs:    60_000 },
  startAssessmentSession:{ maxCalls: 10, windowMs:  60_000 },
  ...
  generateExamBankQuestions: { maxCalls: 3, windowMs: 60_000 },
